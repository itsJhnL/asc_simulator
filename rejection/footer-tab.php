...
echo '<div class="list-group pt-2">
    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist" style="color:black; padding-top: 10px">
        ...
        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == 'ingredients.php' ? 'active' : '') . '" href="ingredients.php">2. Ingredients</a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == '' ? 'active' : '') . '" href="" >5. Secondary Claim</a>
        </li>

        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == '' ? 'active' : '') . '" href="" >6. Documents</a>
        </li>

        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == '' ? 'active' : '') . '" href="" >7. Workflow</a>
        </li>

        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == '' ? 'active' : '') . '" href="" >8. Request(s)</a>
        </li>

        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == '' ? 'active' : '') . '" href="" >9. Custom</a>
        </li>

        <li class="nav-item">
            <a class="nav-link disabled" ' . ($page == '' ? 'active' : '') . '" href="" >10. Quality Event</a>
        </li>
    </ul>
</div>'
