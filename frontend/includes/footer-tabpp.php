...
echo '<div class="list-group">
    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist" style="color:black; padding-top: 10px">
        <li class="nav-item">
            <a class="nav-link" ' . ($page == 'prescriptionpp.php' ? 'active' : '') . '" href="prescriptionpp.php" accesskey="1">1. Prescription</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" ' . ($page == 'ingredientspp.php' ? 'active' : '') . '" href="ingredientspp.php" accesskey="2">2. Ingredients</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" ' . ($page == 'miscpp.php' ? 'active' : '') . '" href="miscpp.php" accesskey="3">3. Misc</a>
        </li>
        
        <li class="nav-item">
            <a class="nav-link" ' . ($page == 'primarypp.php' ? 'active' : '') . '" href="primarypp.php" accesskey="4">4. Primary Claim</a>
        </li>
